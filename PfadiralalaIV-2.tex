...
\input{Lieder-neu/Africa}
\input{Lieder-neu/AllesGute}
...
\input{Lieder-neu/FourChordSong}
...
\input{Lieder-neu/KoksUndNutten}
...
\input{Lieder-neu/Narrenschiff}
\input{Lieder-neu/NunGreiftInDieSaiten}
...
\input{Lieder-neu/DieSandbank}
\input{Lieder-neu/Santiano}
\input{Lieder-neu/DasSchiffImNebel}
\input{Lieder-neu/Seemannsmaetresse}
\input{Lieder-neu/SturmUndDrang}
\input{Lieder-neu/SpaceOddity}
...
\input{Lieder-neu/VielGlueck}
\input{Lieder-neu/VerliebtinDu}
\input{Lieder-neu/WadenEinesBarden}
\input{Lieder-neu/Wanted}
\input{Lieder-neu/WattIhrVolt}
