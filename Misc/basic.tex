...
\newcommand{\setthumb}[2]{
    ...
    \leftwatermark{
        \put(0, -\result) {
            ...
            \put(-69, 0)    {\rule{60pt}{25pt}}
            \put(-34, 0)    {\Huge \color{white} \makebox(25, 25){#1}}
        }
    }
    \rightwatermark{
        \put(0, -\result) {
            \setlength{\unitlength}{1pt}
            \put(362, 0)    {\rule{60pt}{25pt}}
            \put(362, 0)    {\Huge \color{white} \makebox(25, 25){#1}}
        }
    }
    \end{intersong}
}
