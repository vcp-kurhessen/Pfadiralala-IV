\beginsong{Trollträume}[
    wuw={Isabel Eisenträger und kachān}, 
    jahr={2016}, 
    index={Es war war ein mal ein kleiner Troll},
]

\beginverse
\endverse
\includegraphics[draft=false, page=1]{Noten/Trolltraeume.pdf}
...
\beginchorus
Doch \[Hm]kleine Trolle \[D]tun nicht gern, was \[A]man zu ihnen \[D]sagt.
Sie \[Em]singen, tanzen, \[D]springen gern und \[A]das den \[H7]ganzen \[Em]Tag.
\endchorus

\beginverse
Als ^großer Troll hat ^er gelernt, dass ^er dies lieber ^lässt.
Er ^singt und tanzt und ^singt nicht gern, geht ^niemals auf ein ^Fest.
...
Drum ^sing und tanz und ^spring ich gern und ^habe ^ganz viel ^Spaß.
...
\endsong
\beginscripture{}
Das Lied wurde im Jahr 2016 vom Singekreis Mitteldeutschland anlässlich des Hamburger Singewettstreits (HaSiWe) 2017 geschrieben und den ersten Platz in der Kategorie \emph{Singekreise} belegt. Der Singekreis belegte mit diesem Lied auf dem VCP Bundeslager 2017 ebenfalls den ersten Platz.
\endscripture
