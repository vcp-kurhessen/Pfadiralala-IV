\beginsong{Der Karmeliter}[
    wuw={durch mündliche Überlieferung}, 
    jahr={vor 1869},
    bo={352}, 
    pfiii={21}, 
    kssiv={76}, 
    index={War einst ein Karmeliter},
]

\beginverse
\endverse 
\includegraphics[draft=false, width=1\textwidth]{Noten/Lied015.pdf}
...
Das Lied bezieht sich auf die Beichtstuhl-Affäre von 1871/1872, in der ein in der Linzer Tageszeitung erschienener Artikel behauptet, im Beichtstuhl der Karmelitenkirche in Linz sei es zu sexuellen Übergriffen gekommen. 
Die Beichtstuhl-Affäre selbst fällt in die Zeit der Maigesetze in Österreich-Ungarn, bei der zuvor erstrittene Autoritäten der katholischen Kirche wieder zurückgenommen wurden.
Das Lied macht sich über den schwindenden Einfluss der katholischen Kirche und den Pater lustig und war damals Ausdruck der verlorenen Autorität. 
\endscripture
