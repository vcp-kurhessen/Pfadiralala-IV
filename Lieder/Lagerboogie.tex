\beginsong{Lagerboogie}[
    pfii={5},
    index={Ich kenn' die Tante Frieda},
]
...
%\includegraphics[draft=false, width=1\textwidth]{Noten/Lied060.pdf}	
...
Die Oma fängt sich eine Maus, die Kinder tanzen ^Swing.
...
\beginscripture{}
Das Lied ist ein Ausflugs- und Lagerlied ohne besonderen Inhalt. Es lassen sich aber wegen des einfachen Reimschemas sehr leicht neue Strophen schreiben - probiert es mal aus! 

Das Sing Sing (offiziell Sing Sing Correctional Facility) ist ein Hochsicherheitsgefängnis in der Nähe von New York City. Wir haben uns wegen der Verwendung rassistischer Sprache in der dritten Strophe an dieser Stelle für eine Umdichtung entschieden. 
\endscripture
