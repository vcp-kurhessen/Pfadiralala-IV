\beginsong{Uno - Due - Tre}[wuw={Kilian Hähn, Jakob Hoffmann (VCP Bundeslager 2017)}]

\beginchorus
\emph{\[C]Uno, Due, \[G]Tre} - dich im \[C]Kreis,  \emph{Quattro, Cinque, \[G]Sei} - da\[C]bei,
\emph{Sette, Otto, \[G]Nove} - \[F]schön. \emph{Di\[F]eci} - macht am \[G]Ende \[C]zehn.
\endchorus
...
\ifthenelse{\boolean{pics}}{
	\vfill
	\centering\includegraphics[width=\textwidth]{Bilder/Katzo.jpg}
}{}
\end{intersong}