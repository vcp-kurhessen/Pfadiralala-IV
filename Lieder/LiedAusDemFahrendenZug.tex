\beginsong{Lied, aus dem fahrenden Zug zu singen}[
    wuw={Kurt Demmler}, 
    index={Der Zug fährt auf stählernen Gleisen}, 
    siru={49}, 
    biest={528},
]
...
\beginverse
\endverse
\includegraphics[draft=false, page=1]{Noten/LiedAusDemFahrendenZug.pdf}

\beginverse
Der \[Em]Zug nimmt auch \[Am]mit all die \[H7]Feigen, die \[Em]meinen, man \[Am]zahlt heut nicht \[H7]mehr. 
Die \[Am]lassen wir \[Em]kurz mal aussteigen, nur \[D]kurz, und um \[G]ihnen zu \[Em]zeigen: 
