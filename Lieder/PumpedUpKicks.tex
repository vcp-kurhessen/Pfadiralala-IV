\beginsong{Pumped Up Kicks}[wuw={Foster the People}, jahr=2011, alb={Torches}]
...
\beginchorus
\lrep ^All the other kids with the ^pumped up kicks,
you'd better ^run, better run, ^outrun my gun.
^All the other kids with the ^pumped up kicks,
you'd better ^run, better run, ^faster than my bullet. \rrep
\endchorus

\beginverse
^Daddy works a long day, ^
be be ^coming home late, he's ^coming home late.
